...
// mapPopulateFlag is MAP_POPULATE on Linux. Darwin has no equivalent; the
// arena is faulted in explicitly by prefaultArena instead.
...
//
// Darwin arm64/amd64 argument order for SYS_MMAP:
//
//	a1 addr, a2 length, a3 prot, a4 flags, a5 fd, a6 offset
//
// addr = 0 lets the kernel choose; fd = -1 with MAP_ANON means no backing file.
